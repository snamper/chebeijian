<template>
    <div class="succeed">   
       <myHeader title="保养提交失败"/>
       <div class="from_top">
       <div class="succeedcontent">
          <img :src="httpUrl+'modal/failure.png'"/>
          <h2>保养提交失败</h2>
          <!-- <div class="content">
            <p>保养单号：{{order_no}}</p>
            ...
            <p>预计保养时间：{{estimated_maintenance_time}}</p>
          </div> -->
          <div class="succeeBtn">
...
export default {
  ...
  methods: {
    initData() {
      ...
      axios
        .post(
          _this.apihttpUrl + "api/user/userMaintainOrder/detailedOrder?platform=weixin&version=1000&id=" +
            id,
          qs.stringify({
        ...
        .then(function(response) {
          if (response.data.errorCode == 0) {
            var orderInfo = response.data.data.maintain_order_info;
