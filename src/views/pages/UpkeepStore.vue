  ...
  <div class="storesList">
    ...
    <div class="search">
        <div class="fl" >
            ...
            <input class="search-box"  name="q" value="" v-model="keyWords" placeholder="请输入快修店名称" type="text">
        ...
        <li @click="goDetail(storeInfo.id)">
          <div class="row">
            ...
            <div class="col-xs-9">
              ...
              <div>
                <p class="info">营业时间：{{storeInfo.business_hours_start}}-{{storeInfo.business_hours_end}}</p>
      ...
      <div class="ChooseInvoice">
        <div class="footer">
          <div class="button row">
            <button @click="chooseStore(storeInfo.id)">选择</button>
...
export default {
  ...
  methods: {
    ...
    initMap() {
      var map = new AMap.Map("js-container", {
        ...
        zoom: 13, //初始化地图层级
        center: [this.data[0].lng, this.data[0].lat] //初始化地图中心点
      });
      var marker;
      // 定义图标
      ...
      axios
        ...
        .then(function(response) {
          ...
          if (response.data.errorCode == 0) {
            ...
            _this.data = response.data.data.info;
    ...
    chooseStore(id) {
      ...
      var carid = this.$route.query.car_id;
      this.$router.push({
        path: "UpkeepSubmit",
        query: {
          order_id: orderid,
          federation_store_id: id,
          user_vehicle_id: carid
        }
      });
    },
    // 搜索门店
      ...
      axios
        ...
        .then(function(response) {
          ...
          if (response.data.errorCode == 0) {
            ...
            _this.iMap(
              _this.searchReasult[0].lng,
              _this.searchReasult[0].lat,
              _this.searchReasult[0].id
            );
          }
        })
        .catch(function(error) {
  ...
  async created() {
    this.initData();
    await remoteLoad(`http://webapi.amap.com/maps?v=1.3&key=34c9826ca87b43990990360f99fa41d3`)
